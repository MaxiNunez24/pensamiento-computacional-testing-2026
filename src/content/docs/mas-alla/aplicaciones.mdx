...
**numpy** y **pandas** andan acá mismo, en la plataforma: se cargan solos la primera vez que los
importás (tarda unos segundos). Para el resto hace falta **VS Code**, con un entorno virtual como
hicimos con el bot: los gráficos de **matplotlib** se abren en su propia ventana, y **openpyxl**
trabaja con los archivos de Excel de tu compu.

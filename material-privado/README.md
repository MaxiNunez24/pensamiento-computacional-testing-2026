...
| **27/8** | [`SCRUM-EN-EL-CURSO.md`](./SCRUM-EN-EL-CURSO.md) | Cómo trabajar con la metodología **sin explicarla primero**: el arranque de 5 minutos, los sprints de 4 clases, la review y la retro, y qué contestar cuando pregunten por qué se hace así. |
